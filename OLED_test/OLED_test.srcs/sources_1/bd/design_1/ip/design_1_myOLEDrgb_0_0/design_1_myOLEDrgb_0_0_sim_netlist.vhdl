...
-- Date        : Mon Dec  9 03:44:06 2024
-- Host        : DESKTOP-2TI4DL6 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               f:/01_SoC/OLED_test/OLED_test.srcs/sources_1/bd/design_1/ip/design_1_myOLEDrgb_0_0/design_1_myOLEDrgb_0_0_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_myOLEDrgb_0_0_oled_controller is
  port (
    DC : out STD_LOGIC;
    init_done : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    \data_index_reg[0]_0\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
    start : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_myOLEDrgb_0_0_oled_controller : entity is "oled_controller";
end design_1_myOLEDrgb_0_0_oled_controller;

architecture STRUCTURE of design_1_myOLEDrgb_0_0_oled_controller is
  signal \^dc\ : STD_LOGIC;
  signal cmd_index : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal cmd_index_reg : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal \data_index[2]_i_3_n_0\ : STD_LOGIC;
  signal \data_index[2]_i_4_n_0\ : STD_LOGIC;
  signal \data_index[2]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cmd_index_rep[0]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cmd_index_rep[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cmd_index_rep[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cmd_index_rep[3]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \data_index[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_index[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_index[2]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_index[2]_i_5\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of init_done_i_1 : label is "soft_lutpair1";
...
\cmd_index_rep[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\cmd_index_rep[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\cmd_index_rep[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\cmd_index_rep[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
\cmd_index_rep[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\data_index[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7C"
    )
        port map (
...
\data_index[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4F80"
    )
        port map (
      I0 => data_index(0),
      I1 => \state_reg_n_0_[1]\,
      I2 => \data_index[2]_i_2_n_0\,
      I3 => data_index(1),
      O => \data_index[1]_i_1_n_0\
    );
\data_index[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"70FF8000"
    )
        port map (
...
\data_index[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => data_index(2),
      I2 => \data_index[2]_i_4_n_0\,
      I3 => \state[2]_i_2_n_0\,
      I4 => \data_index[2]_i_5_n_0\,
      I5 => \state_reg_n_0_[0]\,
      O => \data_index[2]_i_2_n_0\
    );
\data_index[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3111111111111100"
    )
        port map (
      I0 => data_index(0),
      I1 => data_index(1),
...
\data_index[2]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
...
\data_index[2]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\state[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
        ...
        port map (
      I0 => pixel_index_reg(7),
      I1 => pixel_index_reg(6),
      I2 => pixel_index_reg(5),
      I3 => pixel_index_reg(4),
      O => \state[1]_i_3_n_0\
    );
...
u_oled_controller: entity work.design_1_myOLEDrgb_0_0_oled_controller
     port map (
      DC => DC,
      Q(0) => OLED_start,
      \data_index_reg[0]_0\ => myOLEDrgb_v1_0_S00_AXI_inst_n_1,
      init_done => init_done,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn,
      start => start
