...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  signal Color_index_i_1_n_0 : STD_LOGIC;
  signal Color_index_i_2_n_0 : STD_LOGIC;
  signal \^dc\ : STD_LOGIC;
  ...
  signal color : STD_LOGIC_VECTOR ( 14 to 14 );
  ...
  signal dc_o_i_15_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of Color_index_i_2 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \cmd_index[4]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_o[0]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_o[0]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \data_o[2]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \data_o[4]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_o[6]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_o[6]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_o[7]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \data_o[7]_i_6\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of dc_o_i_14 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of dc_o_i_15 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of dc_o_i_9 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of g0_b0 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of pmoden_o_i_3 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of pmoden_o_i_4 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of res_o_i_3 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of res_o_i_4 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of res_o_i_5 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of res_o_i_7 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of spi_en_i_3 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of spi_en_i_5 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \state[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[4]_i_11\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[4]_i_12\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[4]_i_13\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \state[4]_i_14\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state[4]_i_6\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of timer_clear_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of timer_clear_i_3 : label is "soft_lutpair7";
...
begin
  ...
  VCCEN <= \^vccen\;
  spi_en <= \^spi_en\;
Color_index_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFDFDDFF00002200"
    )
        port map (
...
Color_index_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"42"
    )
        port map (
...
Color_index_reg: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => vccen_o_reg_0,
...
\data_o[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\data_o[2]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\data_o[6]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAABAAA5"
    )
        port map (
...
\data_o[7]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0D"
    )
        port map (
...
dc_o_i_12: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
dc_o_i_15: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
dc_o_i_8: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of CE_i_1 : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[2]_i_2\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_3\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of done_i_1 : label is "soft_lutpair25";
