...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  attribute SOFT_HLUTNM of \data_o[0]_i_2\ : label is "soft_lutpair0";
...
\state[2]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
        ...
        port map (
      I0 => pixel_index_reg(31),
      I1 => pixel_index_reg(18),
...
\state[2]_i_8\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => pixel_index_reg(28),
      I2 => pixel_index_reg(9),
      I3 => pixel_index_reg(16),
      O => \state[2]_i_8_n_0\
    );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  port (
    ...
    spi_en : in STD_LOGIC;
    data_o : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of CE_i_1 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_2\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \shift_reg[4]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \shift_reg[7]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair9";
begin
  MOSI <= \^mosi\;
  spi_done <= \^spi_done\;
...
controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller
     port map (
      ...
      VCCEN => VCCEN,
      data_o(0) => data_o(0),
      res_o_reg_0 => myOLEDrgb_v1_0_S00_AXI_inst_n_1,
