...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_oled_controller is
  ...
  signal \state__7\ : STD_LOGIC_VECTOR ( 1 to 1 );
  ...
  attribute SOFT_HLUTNM of \cmd_index_rep[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cmd_index_rep[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cmd_index_rep[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cmd_index_rep[3]_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \data_index[2]_i_3\ : label is "soft_lutpair1";
...
\data_index[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \state[3]_i_4_n_0\,
      I3 => \state_reg_n_0_[0]\,
      I4 => \data_index[2]_i_4_n_0\,
      I5 => data_index(2),
      O => \data_index[2]_i_2_n_0\
    );
\data_index[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\data_index[2]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000080000000FEFE"
    )
        port map (
      I0 => cmd_index(1),
      I1 => cmd_index(0),
