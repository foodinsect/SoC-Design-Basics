...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  signal \rect_commands[3][7]_i_1_n_0\ : STD_LOGIC;
  signal \rect_commands[7][4]_i_1_n_0\ : STD_LOGIC;
  signal \rect_commands__44\ : STD_LOGIC_VECTOR ( 7 downto 1 );
  signal \rect_commands_reg[3]\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \rect_commands_reg[6]\ : STD_LOGIC_VECTOR ( 7 downto 4 );
  signal \rect_commands_reg[7]\ : STD_LOGIC_VECTOR ( 5 downto 4 );
  ...
  attribute SOFT_HLUTNM of \cmd_index[3]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \cmd_index[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \cmd_index[4]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cmd_index[5]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_o[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \data_o[1]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \data_o[2]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \data_o[3]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \data_o[4]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \data_o[5]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \data_o[5]_i_4\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_o[5]_i_5\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_o[5]_i_6\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \data_o[6]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_o[7]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \data_o[7]_i_5\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of dc_o_i_11 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of dc_o_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of dc_o_i_5 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of dc_o_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of dc_o_i_7 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of dc_o_i_8 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rect_commands[6][4]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \rect_commands[6][5]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \rect_commands[7][4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rect_commands[7][5]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of res_o_i_4 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of res_o_i_5 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of res_o_i_7 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_11\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \state[3]_i_12\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[3]_i_13\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[3]_i_14\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \state[3]_i_15\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of timer_clear_i_4 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of timer_clear_i_6 : label is "soft_lutpair18";
...
\cmd_index[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8828882800008828"
    )
        port map (
      I0 => state(2),
      I1 => \cmd_index_reg_n_0_[3]\,
      I2 => \cmd_index_reg_n_0_[2]\,
      I3 => \cmd_index[3]_i_2_n_0\,
      I4 => state(3),
      I5 => \cmd_index[5]_i_4_n_0\,
      O => \cmd_index[3]_i_1_n_0\
    );
\cmd_index[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\cmd_index[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8808"
    )
        port map (
      I0 => state(2),
      I1 => \cmd_index[4]_i_2_n_0\,
      I2 => state(3),
      I3 => \cmd_index[5]_i_4_n_0\,
      O => \cmd_index[4]_i_1_n_0\
    );
\cmd_index[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\data_o[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E222"
    )
        port map (
      I0 => g0_b0_n_0,
      I1 => state(3),
      I2 => \data_o[5]_i_2_n_0\,
      I3 => \data_o[0]_i_2_n_0\,
      O => \data_o[0]_i_1_n_0\
    );
\data_o[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AA20882022200020"
        ...
        port map (
      I0 => \data_o[5]_i_6_n_0\,
      I1 => \data_o[5]_i_4_n_0\,
      I2 => \rect_commands_reg[3]\(0),
      I3 => \data_o[5]_i_5_n_0\,
      I4 => \rect_commands_reg[6]\(4),
      I5 => \rect_commands_reg[6]\(7),
      O => \data_o[0]_i_2_n_0\
    );
\data_o[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => g0_b1_n_0,
      I1 => state(3),
      I2 => \rect_commands__44\(1),
      O => \data_o[1]_i_1_n_0\
    );
\data_o[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EEE9ACA1EAE9A8A1"
    )
        port map (
      I0 => \cmd_index_reg_n_0_[3]\,
      I1 => \cmd_index_reg_n_0_[1]\,
      ...
      I5 => \rect_commands_reg[3]\(1),
      O => \rect_commands__44\(1)
    );
\data_o[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => g0_b2_n_0,
      I1 => state(3),
      I2 => \rect_commands__44\(2),
      O => \data_o[2]_i_1_n_0\
    );
\data_o[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2038208020082080"
    )
        port map (
      ...
      I5 => \rect_commands_reg[3]\(2),
      O => \rect_commands__44\(2)
    );
...
\data_o[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \cmd_index_reg_n_0_[0]\,
      I5 => \rect_commands_reg[3]\(3),
      O => \rect_commands__44\(3)
    );
\data_o[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFAEFAFA00A20A0A"
    )
        port map (
      I0 => \rect_commands_reg[7]\(4),
      I1 => \cmd_index_reg_n_0_[1]\,
      I2 => \cmd_index_reg_n_0_[0]\,
      I3 => \cmd_index_reg_n_0_[3]\,
      I4 => \cmd_index_reg_n_0_[2]\,
      I5 => \rect_commands_reg[6]\(4),
      O => \data_o[3]_i_3_n_0\
    );
...
\data_o[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A808"
    )
        port map (
      ...
      I1 => g0_b4_n_0,
      I2 => state(3),
      I3 => \rect_commands__44\(4),
      O => \data_o[4]_i_2_n_0\
    );
\data_o[4]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000C00C0CCA000F0"
    )
        port map (
      I0 => \rect_commands_reg[3]\(4),
      I1 => \data_o[3]_i_3_n_0\,
      I2 => \cmd_index_reg_n_0_[0]\,
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \cmd_index_reg_n_0_[1]\,
      I5 => \cmd_index_reg_n_0_[3]\,
      O => \rect_commands__44\(4)
    );
\data_o[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E222"
    )
        port map (
...
\data_o[5]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \rect_commands_reg[3]\(5),
      I2 => \data_o[5]_i_5_n_0\,
      I3 => \rect_commands_reg[6]\(5),
      I4 => \rect_commands_reg[7]\(5),
      I5 => \data_o[5]_i_6_n_0\,
      O => \data_o[5]_i_3_n_0\
    );
...
\data_o[5]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"565E"
    )
        port map (
...
\data_o[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A808"
    )
        port map (
...
\data_o[6]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2038208020082080"
        ...
        port map (
      I0 => \rect_commands_reg[6]\(7),
      I1 => \cmd_index_reg_n_0_[3]\,
      I2 => \cmd_index_reg_n_0_[1]\,
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \cmd_index_reg_n_0_[0]\,
      I5 => \rect_commands_reg[3]\(6),
      O => \rect_commands__44\(6)
    );
...
\data_o[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E2"
    )
        port map (
...
\data_o[7]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \cmd_index_reg_n_0_[0]\,
      I5 => \rect_commands_reg[3]\(7),
      O => \rect_commands__44\(7)
    );
...
\rect_commands[3][7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => state(2),
      I5 => state(1),
      O => \rect_commands[3][7]_i_1_n_0\
    );
\rect_commands[6][4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\rect_commands[6][5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\rect_commands[7][4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0103"
    )
        port map (
      ...
      I2 => y(7),
      I3 => y(5),
      O => \rect_commands[7][4]_i_1_n_0\
    );
\rect_commands[7][5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00005557"
    )
        port map (
...
\rect_commands_reg[3][0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      C => s00_axi_aclk,
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => y(0),
      Q => \rect_commands_reg[3]\(0),
      R => '0'
    );
\rect_commands_reg[3][1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => y(1),
      Q => \rect_commands_reg[3]\(1),
      R => '0'
    );
\rect_commands_reg[3][2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => y(2),
      Q => \rect_commands_reg[3]\(2),
      R => '0'
    );
\rect_commands_reg[3][3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => y(3),
      Q => \rect_commands_reg[3]\(3),
      R => '0'
    );
\rect_commands_reg[3][4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => y(4),
      Q => \rect_commands_reg[3]\(4),
      R => '0'
    );
\rect_commands_reg[3][5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => y(5),
      Q => \rect_commands_reg[3]\(5),
      R => '0'
    );
\rect_commands_reg[3][6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => y(6),
      Q => \rect_commands_reg[3]\(6),
      R => '0'
    );
\rect_commands_reg[3][7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => y(7),
      Q => \rect_commands_reg[3]\(7),
      R => '0'
    );
\rect_commands_reg[6][4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => channel_B(4),
      Q => \rect_commands_reg[6]\(4),
      R => '0'
    );
\rect_commands_reg[6][5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => channel_B(5),
      Q => \rect_commands_reg[6]\(5),
      R => '0'
    );
\rect_commands_reg[6][7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      ...
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => '0',
      Q => \rect_commands_reg[6]\(7),
      R => '0'
    );
\rect_commands_reg[7][4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
      C => s00_axi_aclk,
      CE => \rect_commands[3][7]_i_1_n_0\,
      D => \rect_commands[7][4]_i_1_n_0\,
      Q => \rect_commands_reg[7]\(4),
      R => '0'
    );
\rect_commands_reg[7][5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
timer_clear_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of CE_i_1 : label is "soft_lutpair29";
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[2]_i_2\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of MOSI_i_1 : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \bit_cnt[0]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \bit_cnt[1]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \bit_cnt[2]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_3\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair25";
begin
  MOSI <= \^mosi\;
  spi_done <= \^spi_done\;
