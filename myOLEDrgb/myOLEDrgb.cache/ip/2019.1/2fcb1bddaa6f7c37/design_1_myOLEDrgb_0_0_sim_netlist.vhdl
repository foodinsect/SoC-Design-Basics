...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  attribute SOFT_HLUTNM of \data_o[6]_i_4\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_12\ : label is "soft_lutpair6";
...
\data_o[6]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => wait_timer_reg(2),
      I5 => \data_o[6]_i_4_n_0\,
      O => \data_o[6]_i_3_n_0\
    );
\data_o[6]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of CE_i_1 : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of done_i_1 : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair20";
begin
  MOSI <= \^mosi\;
  spi_done <= \^spi_done\;
