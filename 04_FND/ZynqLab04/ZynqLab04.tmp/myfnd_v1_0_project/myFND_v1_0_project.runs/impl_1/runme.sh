...
HD_PWD='e:/01_soc/04_zynqlab/zynqlab04/zynqlab04.tmp/myfnd_v1_0_project/myFND_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myFND_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myFND_v1_0.tcl -notrace
