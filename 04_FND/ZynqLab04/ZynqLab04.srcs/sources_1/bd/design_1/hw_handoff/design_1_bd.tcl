...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set FND [ create_bd_port -dir O -from 6 -to 0 FND ]
  set SEL [ create_bd_port -dir O -from 0 -to 0 SEL ]
  ...
  connect_bd_net -net myFND_0_oSeg [get_bd_ports FND] [get_bd_pins myFND_0/oSeg]
