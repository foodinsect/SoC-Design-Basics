...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Hex2Dec is
  port (
    ...
    \oSeg[6]_i_16_0\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Hex2Dec is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \oSeg[6]_i_14\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \oSeg[6]_i_15\ : label is "soft_lutpair3";
...
\oSeg[6]_i_10\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\oSeg[6]_i_11\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\oSeg[6]_i_12\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\oSeg[6]_i_13\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\oSeg[6]_i_14\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"56959969"
    )
        port map (
...
\oSeg[6]_i_15\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6B5A294A"
    )
        port map (
...
\oSeg[6]_i_18\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9A18"
    )
        port map (
...
\oSeg[6]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\oSeg[6]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\oSeg[6]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\oSeg[6]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
hex2dec: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Hex2Dec
     port map (
      E(0) => myFND_v1_0_S00_AXI_inst_n_6,
      Q(3 downto 0) => wTen(3 downto 0),
      UNCONN_OUT(3 downto 0) => wOne(3 downto 0),
      \oSeg[6]_i_16_0\(7 downto 0) => wFNDSet(7 downto 0),
