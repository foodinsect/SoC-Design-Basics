...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Hex2Dec is
  port (
    ...
    SR : in STD_LOGIC_VECTOR ( 0 to 0 );
    \oOne_reg[3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s00_axi_aclk : in STD_LOGIC;
    \oTen_reg[3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Hex2Dec is
  ...
  attribute SOFT_HLUTNM of \oSeg[3]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \oSeg[4]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \oSeg[5]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \oSeg[6]_i_2\ : label is "soft_lutpair1";
begin
\oOne_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \oOne_reg[3]_0\(0),
...
\oOne_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \oOne_reg[3]_0\(1),
...
\oOne_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \oOne_reg[3]_0\(2),
...
\oOne_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \oOne_reg[3]_0\(3),
...
\oSeg[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F7BC"
    )
        port map (
...
\oTen_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \oTen_reg[3]_0\(0),
...
\oTen_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \oTen_reg[3]_0\(1),
...
\oTen_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \oTen_reg[3]_0\(2),
...
\oTen_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \oTen_reg[3]_0\(3),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myFND_v1_0_S00_AXI is
  ...
  signal \oOne[1]_i_2_n_0\ : STD_LOGIC;
  signal \oOne[1]_i_3_n_0\ : STD_LOGIC;
  signal \oOne[2]_i_2_n_0\ : STD_LOGIC;
  signal \oOne[2]_i_3_n_0\ : STD_LOGIC;
  signal \oOne[3]_i_2_n_0\ : STD_LOGIC;
  signal \oOne[3]_i_3_n_0\ : STD_LOGIC;
  signal \oTen[0]_i_2_n_0\ : STD_LOGIC;
  signal \oTen[1]_i_2_n_0\ : STD_LOGIC;
  signal p_0_in : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal p_1_in : STD_LOGIC_VECTOR ( 31 downto 7 );
  signal reg_data_out : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal \^s00_axi_bvalid\ : STD_LOGIC;
  signal \^s00_axi_rvalid\ : STD_LOGIC;
  signal \^slv_reg0_reg[1]_0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal wFNDSet : STD_LOGIC_VECTOR ( 7 downto 1 );
  attribute SOFT_HLUTNM : string;
...
begin
  ...
  \slv_reg0_reg[1]_0\(3 downto 0) <= \^slv_reg0_reg[1]_0\(3 downto 0);
...
\oOne[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AFC0"
    )
        port map (
...
\oOne[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"4A29524AA59429A5"
    )
        port map (
      I0 => wFNDSet(5),
      I1 => wFNDSet(2),
...
\oOne[1]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"94A54A525294294A"
    )
        port map (
      I0 => wFNDSet(5),
      I1 => wFNDSet(2),
...
\oOne[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8FFB800"
    )
        port map (
      ...
      I1 => wFNDSet(1),
      I2 => \oOne[2]_i_3_n_0\,
      I3 => \^slv_reg0_reg[1]_0\(0),
      I4 => wFNDSet(2),
      O => \^slv_reg0_reg[1]_0\(2)
    );
\oOne[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8CC6633131188CC6"
    )
        port map (
      I0 => wFNDSet(5),
      I1 => wFNDSet(2),
...
\oOne[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"18C663188C63318C"
    )
        port map (
      I0 => wFNDSet(5),
      I1 => wFNDSet(2),
...
\oOne[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8FFB800"
    )
        port map (
...
\oOne[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1042082184104208"
    )
        port map (
      I0 => wFNDSet(5),
      I1 => wFNDSet(2),
...
\oOne[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2108108484214210"
    )
        port map (
      I0 => wFNDSet(5),
      I1 => wFNDSet(2),
...
\oTen[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8FFB800"
    )
        port map (
...
\oTen[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"B5D6ADB55A6BD65A"
    )
        port map (
      I0 => wFNDSet(5),
      I1 => wFNDSet(2),
...
\oTen[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\oTen[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"400AAFFDFDD4400A"
    )
        port map (
      I0 => wFNDSet(5),
      I1 => wFNDSet(2),
...
\oTen[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => wFNDSet(4),
      I3 => wFNDSet(7),
      I4 => \^slv_reg0_reg[1]_0\(0),
      I5 => wFNDSet(6),
      O => \slv_reg0_reg[5]_0\(2)
    );
\oTen[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"85FFE000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myFND_v1_0 is
  ...
  signal myFND_v1_0_S00_AXI_inst_n_42 : STD_LOGIC;
  signal myFND_v1_0_S00_AXI_inst_n_43 : STD_LOGIC;
  signal myFND_v1_0_S00_AXI_inst_n_44 : STD_LOGIC;
  signal myFND_v1_0_S00_AXI_inst_n_45 : STD_LOGIC;
...
hex2dec: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Hex2Dec
     port map (
      D(6 downto 0) => p_0_out(6 downto 0),
      SR(0) => myFND_v1_0_S00_AXI_inst_n_1,
      \oOne_reg[3]_0\(3) => myFND_v1_0_S00_AXI_inst_n_6,
      \oOne_reg[3]_0\(2) => myFND_v1_0_S00_AXI_inst_n_7,
      \oOne_reg[3]_0\(1) => myFND_v1_0_S00_AXI_inst_n_8,
      \oOne_reg[3]_0\(0) => wDECSet,
      \oSeg_reg[2]\ => \^osel\,
      \oTen_reg[3]_0\(3) => myFND_v1_0_S00_AXI_inst_n_42,
      \oTen_reg[3]_0\(2) => myFND_v1_0_S00_AXI_inst_n_43,
      \oTen_reg[3]_0\(1) => myFND_v1_0_S00_AXI_inst_n_44,
      \oTen_reg[3]_0\(0) => myFND_v1_0_S00_AXI_inst_n_45,
      s00_axi_aclk => s00_axi_aclk
    );
myFND_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myFND_v1_0_S00_AXI
     port map (
      ...
      \slv_reg0_reg[1]_0\(3) => myFND_v1_0_S00_AXI_inst_n_6,
      \slv_reg0_reg[1]_0\(2) => myFND_v1_0_S00_AXI_inst_n_7,
      \slv_reg0_reg[1]_0\(1) => myFND_v1_0_S00_AXI_inst_n_8,
      \slv_reg0_reg[1]_0\(0) => wDECSet,
      \slv_reg0_reg[5]_0\(3) => myFND_v1_0_S00_AXI_inst_n_42,
      \slv_reg0_reg[5]_0\(2) => myFND_v1_0_S00_AXI_inst_n_43,
      \slv_reg0_reg[5]_0\(1) => myFND_v1_0_S00_AXI_inst_n_44,
      \slv_reg0_reg[5]_0\(0) => myFND_v1_0_S00_AXI_inst_n_45
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
