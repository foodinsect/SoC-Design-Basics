...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = myBuzzer
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myBuzzer_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myDCMotor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myDCMotor_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myMAXSONAR
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myMAXSONAR_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myOLEDrgb
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myOLEDrgb_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = mySwitch
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = mySwitch_0
END
