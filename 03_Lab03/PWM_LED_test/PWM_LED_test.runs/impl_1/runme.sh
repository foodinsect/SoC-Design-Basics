...
HD_PWD='E:/SoC/03_Lab03/PWM_LED_test/PWM_LED_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_12bit_LED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_12bit_LED.tcl -notrace
