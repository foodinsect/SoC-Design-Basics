...
HD_PWD='E:/SoC/03_Lab03/PWM_LED_test/PWM_LED_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_12bit_LED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_12bit_LED.tcl
