...
HD_PWD='F:/01_SoC/TermProject/TermProject.runs/design_1_myDCMotor_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myDCMotor_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myDCMotor_0_3.tcl
