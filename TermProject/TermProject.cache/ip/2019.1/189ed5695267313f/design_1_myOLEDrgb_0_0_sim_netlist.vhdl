...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  port (
    ...
    \data_o_reg[7]_1\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    s00_axi_aresetn : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  signal res_o_i_19_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cmd_index[4]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \cmd_index[5]_i_5\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_o[0]_i_4\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \data_o[0]_i_5\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_o[0]_i_6\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \data_o[4]_i_5\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_o[5]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \data_o[5]_i_4\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \data_o[5]_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_o[7]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of dc_o_i_7 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of dc_o_i_9 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \pixel_index[15]_i_1\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \pixel_index[19]_i_1\ : label is "soft_lutpair26";
  ...
  attribute SOFT_HLUTNM of \pixel_index[22]_i_1\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \pixel_index[28]_i_1\ : label is "soft_lutpair32";
  ...
  attribute SOFT_HLUTNM of \pixel_index[31]_i_2\ : label is "soft_lutpair35";
  ...
  attribute SOFT_HLUTNM of pmoden_o_i_6 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rect_cmds[4][5]_i_4\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of res_o_i_13 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of res_o_i_14 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of res_o_i_16 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of res_o_i_18 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of res_o_i_2 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of res_o_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of res_o_i_8 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of spi_en_i_2 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of spi_en_i_3 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of spi_en_i_4 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state[2]_i_12\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \state[4]_i_10\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of timer_clear_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of timer_clear_i_3 : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of timer_clear_i_8 : label is "soft_lutpair20";
begin
  DC <= \^dc\;
  PMODEN <= \^pmoden\;
  Q(0) <= \^q\(0);
...
\data_o[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \data_o[0]_i_4_n_0\,
      I2 => \data_o[0]_i_5_n_0\,
...
\data_o[0]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EA9D"
    )
        port map (
...
\data_o[0]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\data_o[5]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\rect_cmds[4][5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000004008"
        ...
        port map (
      I0 => state_reg(0),
      I1 => \rect_cmds_reg[7][0]_0\,
      I2 => state_reg(3),
      I3 => state_reg(2),
      I4 => spi_done,
      I5 => \rect_cmds[4][5]_i_4_n_0\,
...
res_o_i_13: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
res_o_i_14: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
res_o_i_18: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
res_o_i_19: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
spi_en_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"04500024"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM of \state[4]_i_11\ : label is "soft_lutpair44";
begin
  MOSI <= \^mosi\;
  spi_done <= \^spi_done\;
