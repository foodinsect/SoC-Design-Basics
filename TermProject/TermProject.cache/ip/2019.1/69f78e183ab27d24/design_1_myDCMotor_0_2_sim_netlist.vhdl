...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PWM is
  ...
  attribute SOFT_HLUTNM of \rCount[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rCount[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rCount[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rCount[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rCount[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rDuty[7]_i_2\ : label is "soft_lutpair6";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_controller is
  ...
  signal pwm_duty10_in : STD_LOGIC;
  signal \pwm_duty1_inferred__0/i__carry__0_n_1\ : STD_LOGIC;
  signal \pwm_duty1_inferred__0/i__carry__0_n_2\ : STD_LOGIC;
  signal \pwm_duty1_inferred__0/i__carry__0_n_3\ : STD_LOGIC;
  signal \pwm_duty1_inferred__0/i__carry__0_n_4\ : STD_LOGIC;
  ...
  signal \NLW_pwm_duty1_inferred__0/i__carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \i__carry__0_i_8\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \i__carry__0_i_9\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \pwm_duty[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \pwm_duty[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \pwm_duty[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \pwm_duty[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \pwm_duty[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \pwm_duty[5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \pwm_duty[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \pwm_duty[7]_i_1\ : label is "soft_lutpair4";
begin
...
\pwm_duty1_inferred__0/i__carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_pwm_duty1_inferred__0/i__carry__0_CO_UNCONNECTED\(3),
      CO(2) => \pwm_duty1_inferred__0/i__carry__0_n_1\,
      CO(1) => \pwm_duty1_inferred__0/i__carry__0_n_2\,
      CO(0) => \pwm_duty1_inferred__0/i__carry__0_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => A(3 downto 1),
      O(3) => \pwm_duty1_inferred__0/i__carry__0_n_4\,
...
\pwm_duty[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
        ...
        port map (
      I0 => pwm_duty10_in,
      I1 => \pwm_duty1_inferred__0/i__carry_n_7\,
      I2 => \pwm_duty[7]_i_3_n_0\,
      O => \pwm_duty[0]_i_1_n_0\
    );
\pwm_duty[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => pwm_duty10_in,
      I1 => \pwm_duty1_inferred__0/i__carry_n_6\,
      I2 => \pwm_duty[7]_i_3_n_0\,
      O => \pwm_duty[1]_i_1_n_0\
    );
\pwm_duty[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => pwm_duty10_in,
      I1 => \pwm_duty1_inferred__0/i__carry_n_5\,
      I2 => \pwm_duty[7]_i_3_n_0\,
      O => \pwm_duty[2]_i_1_n_0\
    );
\pwm_duty[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => pwm_duty10_in,
      I1 => \pwm_duty1_inferred__0/i__carry_n_4\,
      I2 => \pwm_duty[7]_i_3_n_0\,
      O => \pwm_duty[3]_i_1_n_0\
    );
\pwm_duty[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => pwm_duty10_in,
      I1 => \pwm_duty1_inferred__0/i__carry__0_n_7\,
      I2 => \pwm_duty[7]_i_3_n_0\,
      O => \pwm_duty[4]_i_1_n_0\
    );
\pwm_duty[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => pwm_duty10_in,
      I1 => \pwm_duty1_inferred__0/i__carry__0_n_6\,
      I2 => \pwm_duty[7]_i_3_n_0\,
      O => \pwm_duty[5]_i_1_n_0\
    );
\pwm_duty[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => pwm_duty10_in,
      I1 => \pwm_duty1_inferred__0/i__carry__0_n_5\,
      I2 => \pwm_duty[7]_i_3_n_0\,
      O => \pwm_duty[6]_i_1_n_0\
    );
\pwm_duty[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => \pwm_duty1_inferred__0/i__carry__0_n_4\,
      I1 => pwm_duty10_in,
      I2 => \pwm_duty[7]_i_3_n_0\,
