...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PWM is
  port (
    ...
    pwm_duty : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PWM is
  ...
  signal rDuty : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \rDuty[0]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \rCount[1]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \rCount[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rDuty[0]_i_1\ : label is "soft_lutpair3";
begin
...
\rCount[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\rCount[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
\rCount[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\rDuty[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
rPWM1_carry_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
rPWM1_carry_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
rPWM1_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
rPWM1_carry_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F4"
    )
        port map (
...
rPWM1_carry_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
rPWM1_carry_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
rPWM1_carry_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
rPWM1_carry_i_8: unisim.vcomponents.LUT3
    generic map(
      INIT => X"09"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_controller is
  port (
    pwm_duty : out STD_LOGIC_VECTOR ( 0 to 0 );
    s00_axi_aclk : in STD_LOGIC;
    \error_reg[0]_0\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_controller is
  ...
  signal error0 : STD_LOGIC_VECTOR ( 2 downto 1 );
  ...
  signal \pwm_duty0_carry__0_n_0\ : STD_LOGIC;
  ...
  signal pwm_duty1 : STD_LOGIC_VECTOR ( 7 downto 2 );
  signal \pwm_duty1_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \pwm_duty1_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \pwm_duty1_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \pwm_duty1_carry__0_i_4_n_0\ : STD_LOGIC;
  signal \pwm_duty1_carry__0_n_3\ : STD_LOGIC;
  ...
  signal \NLW_pwm_duty0_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_pwm_duty1_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_pwm_duty1_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \error[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \error[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \error[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \error[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \error[5]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \error[7]_i_2\ : label is "soft_lutpair0";
begin
\error[1]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\error[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"87"
    )
        port map (
...
\error[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EA15"
    )
        port map (
...
\error[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFEA0015"
    )
        port map (
...
\error[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\error[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFEA"
    )
        port map (
...
pwm_duty0_carry_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
pwm_duty0_carry_i_2: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
pwm_duty0_carry_i_3: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
pwm_duty1_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => error(3),
      DI(0) => '0',
      O(3 downto 0) => pwm_duty1(5 downto 2),
      S(3) => pwm_duty1_carry_i_3_n_0,
      S(2) => pwm_duty1_carry_i_4_n_0,
      S(1) => pwm_duty1_carry_i_5_n_0,
      S(0) => pwm_duty1_carry_i_6_n_0
    );
\pwm_duty1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => pwm_duty1_carry_n_0,
      CO(3 downto 1) => \NLW_pwm_duty1_carry__0_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \pwm_duty1_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \pwm_duty1_carry__0_i_1_n_0\,
      O(3 downto 2) => \NLW_pwm_duty1_carry__0_O_UNCONNECTED\(3 downto 2),
      O(1 downto 0) => pwm_duty1(7 downto 6),
      S(3 downto 2) => B"00",
      S(1) => \pwm_duty1_carry__0_i_2_n_0\,
      S(0) => \pwm_duty1_carry__0_i_3_n_0\
    );
\pwm_duty1_carry__0_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => error(0),
      I5 => error(2),
      O => \pwm_duty1_carry__0_i_1_n_0\
    );
\pwm_duty1_carry__0_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5554AAAB"
    )
        port map (
      I0 => \pwm_duty1_carry__0_i_4_n_0\,
      I1 => error(5),
      I2 => error(3),
      I3 => error(4),
      I4 => error(7),
      O => \pwm_duty1_carry__0_i_2_n_0\
    );
\pwm_duty1_carry__0_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01FEFE01"
    )
        port map (
      ...
      I1 => error(3),
      I2 => error(5),
      I3 => \pwm_duty1_carry__0_i_4_n_0\,
      I4 => error(6),
      O => \pwm_duty1_carry__0_i_3_n_0\
    );
\pwm_duty1_carry__0_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
      ...
      I1 => error(0),
      I2 => error(2),
      O => \pwm_duty1_carry__0_i_4_n_0\
    );
pwm_duty1_carry_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
pwm_duty1_carry_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
pwm_duty1_carry_i_3: unisim.vcomponents.LUT6
    generic map(
...
pwm_duty1_carry_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FE0101FE"
    )
        port map (
...
pwm_duty1_carry_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1E"
    )
        port map (
...
\pwm_duty[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => pwm_duty1(7),
      I1 => \pwm_duty0_carry__0_n_0\,
