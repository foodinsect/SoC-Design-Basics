...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_BeepMaker is
  ...
  signal \oBUZ0_carry__1_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \counter[26]_i_1\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \counter[30]_i_11\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter[30]_i_12\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter[30]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter[30]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter[30]_i_8\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter[30]_i_9\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \oBUZ0_carry__1_i_9\ : label is "soft_lutpair0";
begin
  wBUZ <= \^wbuz\;
...
\counter[30]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\counter[30]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FCFCFCFFFCFBF3F3"
    )
        port map (
      I0 => distance(0),
      I1 => distance(3),
      I2 => \counter[30]_i_8_n_0\,
      I3 => distance(4),
      I4 => distance(1),
      I5 => distance(2),
...
\oBUZ0_carry__1_i_9\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"001000E0"
    )
        port map (
...
oBUZ0_carry_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFD00"
    )
        port map (
...
oBUZ0_carry_i_8: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000002FD"
    )
        port map (
