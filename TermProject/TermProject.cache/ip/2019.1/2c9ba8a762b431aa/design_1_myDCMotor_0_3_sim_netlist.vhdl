...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PWM is
  ...
  signal \rCount[7]_i_3_n_0\ : STD_LOGIC;
  signal rCount_reg : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal rDuty : STD_LOGIC_VECTOR ( 7 to 7 );
  signal \rDuty[7]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \rCount[6]_i_2\ : label is "soft_lutpair1";
begin
...
\rCount[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B8CC"
    )
        port map (
...
\rCount[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
rPWM1_carry_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
...
rPWM1_carry_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
...
rPWM1_carry_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0E"
    )
        port map (
...
rPWM1_carry_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"81"
    )
        port map (
...
rPWM1_carry_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"81"
    )
        port map (
...
rPWM1_carry_i_7: unisim.vcomponents.LUT3
    generic map(
      INIT => X"81"
    )
        port map (
