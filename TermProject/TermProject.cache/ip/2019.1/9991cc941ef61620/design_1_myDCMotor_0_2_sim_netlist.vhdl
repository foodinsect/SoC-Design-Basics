...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pwm_controller is
  ...
  signal \pwm_duty0_carry__0_i_5_n_0\ : STD_LOGIC;
  signal \pwm_duty0_carry__0_i_6_n_0\ : STD_LOGIC;
  signal \pwm_duty0_carry__0_i_7_n_0\ : STD_LOGIC;
  signal \pwm_duty0_carry__0_i_8_n_0\ : STD_LOGIC;
  signal \pwm_duty0_carry__0_i_9_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \pwm_duty0_carry__0_i_8\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \pwm_duty0_carry__0_i_9\ : label is "soft_lutpair0";
...
\pwm_duty0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \pwm_duty0_carry__0_i_4_n_0\,
      S(2) => \pwm_duty0_carry__0_i_5_n_0\,
      S(1) => \pwm_duty0_carry__0_i_6_n_0\,
      S(0) => \pwm_duty0_carry__0_i_7_n_0\
    );
\pwm_duty0_carry__0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE01"
    )
        port map (
...
\pwm_duty0_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A9"
    )
        port map (
...
\pwm_duty0_carry__0_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"69696956"
    )
        port map (
      I0 => distance(7),
      I1 => distance(4),
      I2 => \pwm_duty0_carry__0_i_8_n_0\,
      I3 => distance(5),
      I4 => distance(6),
      O => \pwm_duty0_carry__0_i_4_n_0\
    );
\pwm_duty0_carry__0_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"A5599669"
    )
        port map (
      I0 => distance(6),
      I1 => distance(5),
      I2 => \pwm_duty0_carry__0_i_9_n_0\,
      I3 => distance(3),
      I4 => distance(4),
      O => \pwm_duty0_carry__0_i_5_n_0\
    );
\pwm_duty0_carry__0_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => distance(0),
      I5 => distance(2),
      O => \pwm_duty0_carry__0_i_6_n_0\
    );
\pwm_duty0_carry__0_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"5AA55AA6"
    )
        port map (
      ...
      I3 => distance(1),
      I4 => distance(3),
      O => \pwm_duty0_carry__0_i_7_n_0\
    );
\pwm_duty0_carry__0_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
      ...
      I2 => distance(1),
      I3 => distance(3),
      O => \pwm_duty0_carry__0_i_8_n_0\
    );
\pwm_duty0_carry__0_i_9\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
pwm_duty0_carry_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1E"
    )
        port map (
...
pwm_duty0_carry_i_5: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
