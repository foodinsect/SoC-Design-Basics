...
##Pmod Header JD                                                                                                                  
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { oPWM }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { buzzer }]; #IO_L19P_T3_35 Sch=je[4]                     
