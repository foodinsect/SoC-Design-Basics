...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  signal \^fsm_onehot_current_state_reg[0]_0\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute XILINX_LEGACY_PRIM of \FSM_onehot_next_state_reg[0]\ : label is "LDP";
  attribute XILINX_LEGACY_PRIM of \FSM_onehot_next_state_reg[1]\ : label is "LDC";
  attribute XILINX_LEGACY_PRIM of \FSM_onehot_next_state_reg[2]\ : label is "LDC";
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_next_state_reg[2]_i_1\ : label is "soft_lutpair1";
...
CS_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFBFFFFFFAAAA"
        ...
        port map (
      I0 => \^fsm_onehot_current_state_reg[0]_0\(0),
...
\FSM_onehot_current_state_reg[0]\: unisim.vcomponents.FDPE
    generic map(
      ...
      PRE => AS(0),
      Q => \^fsm_onehot_current_state_reg[0]_0\(0)
    );
...
\FSM_onehot_next_state_reg[0]\: unisim.vcomponents.LDPE
    generic map(
      INIT => '1'
    )
        port map (
...
\FSM_onehot_next_state_reg[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
OLEDrgb_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_OLEDrgb_v1_0_S00_AXI
     port map (
      AS(0) => OLEDrgb_v1_0_S00_AXI_inst_n_1,
      DC => DC,
      MOSI => \^mosi\,
      PMODEN => PMODEN,
      Q(0) => sel0(0),
      ...
      \axi_rdata_reg[0]_i_3_0\(0) => spi_n_3,
...
spi: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master
     port map (
      AS(0) => OLEDrgb_v1_0_S00_AXI_inst_n_1,
      CS_reg_0 => \^cs_reg\,
      \FSM_onehot_current_state_reg[0]_0\(0) => spi_n_3,
      MOSI => \^mosi\,
      Q(0) => \^q\(0),
      SCK => SCK,
