...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  signal \bit_cnt_reg[3]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of CS_reg_i_2 : label is "soft_lutpair2";
  attribute XILINX_LEGACY_PRIM of MOSI_reg : label is "LDC";
  attribute SOFT_HLUTNM of MOSI_reg_i_1 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \bit_cnt_reg[3]_i_2\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \next_state_reg[0]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \shift_reg_reg[1]_i_1\ : label is "soft_lutpair6";
...
\bit_cnt_reg[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0F2F0F20"
    )
        port map (
