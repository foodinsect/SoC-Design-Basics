...
proc create_root_design { parentCell } {
  ...
  set CS_LED [ create_bd_port -dir O CS_LED ]
  ...
  set OLEDrgb_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:OLEDrgb:1.0 OLEDrgb_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins OLEDrgb_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net OLEDrgb_0_CS [get_bd_ports CS] [get_bd_ports CS_LED] [get_bd_pins OLEDrgb_0/CS]
  connect_bd_net -net OLEDrgb_0_DC [get_bd_ports DC] [get_bd_pins OLEDrgb_0/DC]
  connect_bd_net -net OLEDrgb_0_MOSI [get_bd_ports MOSI] [get_bd_pins OLEDrgb_0/MOSI]
  connect_bd_net -net OLEDrgb_0_PMODEN [get_bd_ports PMODEN] [get_bd_pins OLEDrgb_0/PMODEN]
  connect_bd_net -net OLEDrgb_0_RES [get_bd_ports RES] [get_bd_pins OLEDrgb_0/RES]
  connect_bd_net -net OLEDrgb_0_SCK [get_bd_ports SCK] [get_bd_pins OLEDrgb_0/SCK]
  connect_bd_net -net OLEDrgb_0_VCCEN [get_bd_ports VCCEN] [get_bd_pins OLEDrgb_0/VCCEN]
  connect_bd_net -net OLEDrgb_0_spi_busy [get_bd_ports SPI_BUSY] [get_bd_pins OLEDrgb_0/spi_busy]
  connect_bd_net -net OLEDrgb_0_spi_done [get_bd_ports SPI_DONE] [get_bd_pins OLEDrgb_0/spi_done]
  connect_bd_net -net OLEDrgb_0_spi_start [get_bd_ports SPI_EN] [get_bd_pins OLEDrgb_0/spi_en]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins OLEDrgb_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins OLEDrgb_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs OLEDrgb_0/S00_AXI/S00_AXI_reg] SEG_OLEDrgb_0_S00_AXI_reg
