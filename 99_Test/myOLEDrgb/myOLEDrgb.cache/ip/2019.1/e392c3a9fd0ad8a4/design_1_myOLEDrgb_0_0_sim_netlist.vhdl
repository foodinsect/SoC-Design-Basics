...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  signal \rect_commands__2\ : STD_LOGIC_VECTOR ( 7 downto 6 );
  signal \rect_commands_reg[3]\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \rect_commands_reg[5]\ : STD_LOGIC_VECTOR ( 7 to 7 );
  signal \rect_commands_reg[6]\ : STD_LOGIC_VECTOR ( 5 downto 4 );
  ...
  attribute SOFT_HLUTNM of \cmd_index[3]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cmd_index[4]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \cmd_index[4]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cmd_index[5]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \data_o[0]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_o[3]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_o[4]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_o[5]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_o[6]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \data_o[7]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \data_o[7]_i_4\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of dc_o_i_6 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of dc_o_i_7 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of dc_o_i_8 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rect_commands[6][4]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \rect_commands[6][5]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \rect_commands[7][4]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rect_commands[7][5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of res_o_i_4 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of res_o_i_5 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of res_o_i_7 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of spi_en_i_3 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_10\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[3]_i_11\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \state[3]_i_12\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state[3]_i_13\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \state[3]_i_14\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of timer_clear_i_4 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of timer_clear_i_6 : label is "soft_lutpair19";
...
\data_o[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CFC0C0C0A0F0A0F0"
    )
        port map (
      I0 => \rect_commands_reg[6]\(4),
      I1 => \rect_commands_reg[5]\(7),
      I2 => \data_o[0]_i_4_n_0\,
      I3 => \cmd_index_reg_n_0_[1]\,
      I4 => \rect_commands_reg[3]\(0),
      I5 => \cmd_index_reg_n_0_[0]\,
      O => \data_o[0]_i_3_n_0\
    );
\data_o[0]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\data_o[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8A8C8A80BAB3BAB3"
    )
        port map (
      I0 => \data_o[3]_i_4_n_0\,
      I1 => \cmd_index_reg_n_0_[1]\,
      I2 => \cmd_index_reg_n_0_[3]\,
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \rect_commands_reg[3]\(1),
      I5 => \cmd_index_reg_n_0_[0]\,
      O => \data_o[1]_i_2_n_0\
    );
...
\data_o[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \cmd_index_reg_n_0_[3]\,
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \rect_commands_reg[3]\(3),
      I5 => \cmd_index_reg_n_0_[0]\,
      O => \data_o[3]_i_3_n_0\
    );
\data_o[3]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AFA0CFCF"
    )
        port map (
      I0 => \rect_commands_reg[7]\(4),
      I1 => \rect_commands_reg[6]\(4),
      I2 => \cmd_index_reg_n_0_[1]\,
      I3 => \rect_commands_reg[5]\(7),
      I4 => \cmd_index_reg_n_0_[0]\,
      O => \data_o[3]_i_4_n_0\
    );
...
\data_o[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \data_o[3]_i_2_n_0\,
      O => \data_o[4]_i_2_n_0\
    );
\data_o[4]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFC0AF00A0C0AF00"
    )
        port map (
...
\data_o[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BABF8A808A808A80"
        ...
        port map (
      I0 => \rect_commands_reg[7]\(5),
      I1 => \cmd_index_reg_n_0_[1]\,
      I2 => \cmd_index_reg_n_0_[3]\,
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \cmd_index_reg_n_0_[0]\,
      I5 => \rect_commands_reg[6]\(5),
      O => \data_o[5]_i_2_n_0\
    );
\data_o[5]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \cmd_index_reg_n_0_[3]\,
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \rect_commands_reg[3]\(5),
      I5 => \cmd_index_reg_n_0_[0]\,
      O => \data_o[5]_i_3_n_0\
    );
\data_o[5]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AFA0CFCF"
    )
        port map (
      I0 => \rect_commands_reg[7]\(5),
      I1 => \rect_commands_reg[6]\(5),
      I2 => \cmd_index_reg_n_0_[1]\,
      I3 => \rect_commands_reg[5]\(7),
      I4 => \cmd_index_reg_n_0_[0]\,
      O => \data_o[5]_i_4_n_0\
...
\data_o[6]_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \cmd_index_reg_n_0_[1]\,
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \rect_commands_reg[3]\(6),
      I5 => \cmd_index_reg_n_0_[0]\,
      O => \rect_commands__2\(6)
    );
...
\data_o[7]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \cmd_index_reg_n_0_[1]\,
      I3 => \cmd_index_reg_n_0_[2]\,
      I4 => \rect_commands_reg[3]\(7),
      I5 => \cmd_index_reg_n_0_[0]\,
      O => \rect_commands__2\(7)
    );
...
\rect_commands[3][7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000080"
    )
        port map (
...
\rect_commands_reg[5][7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of CE_i_1 : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of MOSI_i_1 : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_3\ : label is "soft_lutpair28";
  ...
  attribute SOFT_HLUTNM of \counter[3]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \shift_reg[0]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \shift_reg[3]_i_1\ : label is "soft_lutpair25";
