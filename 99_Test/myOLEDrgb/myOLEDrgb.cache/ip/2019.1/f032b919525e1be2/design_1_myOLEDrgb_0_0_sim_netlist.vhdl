...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  attribute SOFT_HLUTNM of \cmd_index[0]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \cmd_index[1]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \cmd_index[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \cmd_index[3]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \cmd_index[5]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_o[1]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \data_o[3]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_o[3]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \data_o[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_o[5]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_o[7]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of dc_o_i_2 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of dc_o_i_3 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of dc_o_i_4 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of dc_o_i_5 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of dc_o_i_9 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \rect_cmds[7][5]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rect_cmds[9][3]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of res_o_i_2 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of spi_en_i_4 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of spi_en_i_5 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of spi_en_i_6 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_11\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \state[3]_i_12\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state[3]_i_14\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[3]_i_16\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state[3]_i_17\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[3]_i_18\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \state[3]_i_19\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of timer_clear_i_4 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of timer_clear_i_7 : label is "soft_lutpair4";
begin
  DC <= \^dc\;
  PMODEN <= \^pmoden\;
  RES <= \^res\;
...
\data_o[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BBBBF3F3FF33F3F3"
    )
        port map (
      I0 => \data_o[3]_i_3_n_0\,
      I1 => \state_reg_n_0_[0]\,
      I2 => g0_b1_n_0,
      I3 => \data_o[1]_i_2_n_0\,
      I4 => \state_reg_n_0_[3]\,
      I5 => cmd_index(3),
      O => \data_o[1]_i_1_n_0\
    );
\data_o[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CCF0CC00AA00FF00"
    )
        port map (
      I0 => \rect_cmds_reg[5]\(5),
      I1 => \data_o[1]_i_3_n_0\,
      I2 => \rect_cmds_reg[3]\(1),
      I3 => cmd_index(2),
      I4 => cmd_index(0),
      I5 => cmd_index(1),
      O => \data_o[1]_i_2_n_0\
    );
\data_o[1]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      I0 => \rect_cmds_reg[10]\(4),
      I1 => cmd_index(0),
      I2 => \rect_cmds_reg[6]\(4),
      O => \data_o[1]_i_3_n_0\
    );
...
\data_o[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"E2E2CC000000FFFF"
    )
        port map (
      I0 => \rect_cmds_reg[3]\(2),
      I1 => cmd_index(2),
      I2 => \rect_cmds_reg[10]\(4),
      I3 => \rect_cmds_reg[6]\(4),
      I4 => cmd_index(0),
      I5 => cmd_index(1),
      O => \data_o[2]_i_2_n_0\
    );
\data_o[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FDFDFD5DFD5DFD5D"
    )
        port map (
      I0 => \state_reg_n_0_[0]\,
      I1 => g0_b3_n_0,
      I2 => \state_reg_n_0_[3]\,
      I3 => \data_o[3]_i_2_n_0\,
      I4 => cmd_index(3),
...
\data_o[3]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00003808"
        ...
        port map (
      I0 => \rect_cmds_reg[9]\(3),
      I1 => cmd_index(0),
      I2 => cmd_index(1),
      I3 => \rect_cmds_reg[10]\(4),
      I4 => cmd_index(2),
      O => \data_o[3]_i_3_n_0\
    );
...
\data_o[4]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => cmd_index(0),
      I3 => cmd_index(1),
      I4 => \rect_cmds_reg[3]\(4),
      I5 => cmd_index(3),
      O => \data_o[4]_i_3_n_0\
    );
\data_o[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FDFDFDFDFDFDFD5D"
    )
        port map (
      I0 => \state_reg_n_0_[0]\,
      I1 => g0_b5_n_0,
...
\data_o[5]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BF8FB38300000000"
    )
        port map (
      I0 => \rect_cmds_reg[7]\(5),
      I1 => cmd_index(0),
      I2 => cmd_index(1),
      I3 => \rect_cmds_reg[6]\(5),
      I4 => \rect_cmds_reg[5]\(5),
      I5 => cmd_index(2),
      O => \data_o[5]_i_5_n_0\
    );
...
\data_o[7]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \state_reg_n_0_[3]\,
      I4 => \state_reg_n_0_[1]\,
      I5 => \wait_init_done__23\,
      O => \data_o[7]_i_1_n_0\
    );
\data_o[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"55F5DDDD5555DDDD"
    )
        port map (
      I0 => \state_reg_n_0_[0]\,
      I1 => g0_b7_n_0,
...
\rect_cmds[9][3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\rect_cmds_reg[10][4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\rect_cmds_reg[5][5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\rect_cmds_reg[9][3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\rect_cmds_reg[9][5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
res_o_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFBF00000031"
    )
        port map (
      I0 => \state_reg_n_0_[1]\,
      I1 => \state_reg_n_0_[0]\,
      I2 => \wait_timer_done__23\,
      I3 => \state_reg_n_0_[2]\,
      I4 => \state_reg_n_0_[3]\,
      I5 => \^res\,
      O => res_o_i_1_n_0
...
spi_en_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM of \bit_cnt[2]_i_1\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair26";
begin
  MOSI <= \^mosi\;
  spi_done <= \^spi_done\;
