...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_oled_controller is
  signal FSM_sequential_pixel_byte_state_i_1_n_0 : STD_LOGIC;
  ...
  signal pixel_index_reg : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  signal \NLW_pixel_index_reg[12]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of FSM_sequential_pixel_byte_state_reg : label is "iSTATE:1,iSTATE0:0,";
  ...
  attribute SOFT_HLUTNM of \cmd_index_rep[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \cmd_index_rep[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \cmd_index_rep[3]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \cmd_index_rep[3]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \data_o[0]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \data_o[1]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \data_o[2]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \data_o[3]_i_2\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \data_o[6]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \data_o[7]_i_2\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_6\ : label is "soft_lutpair19";
begin
  PMODEN <= \^pmoden\;
  RES <= \^res\;
  SPI_start <= \^spi_start\;
FSM_sequential_pixel_byte_state_i_1: unisim.vcomponents.LUT6
    generic map(
...
FSM_sequential_pixel_byte_state_reg: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      CLR => SR(0),
...
\data_o[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AC21"
    )
        port map (
...
\data_o[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"C84B"
    )
        port map (
...
\data_o[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8C4B"
    )
        port map (
...
\pixel_index_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_pixel_index_reg[12]_i_1_CO_UNCONNECTED\(3),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM of SCK_INST_0 : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_3\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \shift_reg[15]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \shift_reg[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \shift_reg[5]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \shift_reg[6]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair7";
begin
  CS <= \^cs\;
...
myOLEDrgb_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myOLEDrgb_v1_0_S00_AXI
     port map (
      Q(15 downto 0) => pixel(15 downto 0),
      ...
      \slv_reg2_reg[0]_0\(0) => pixel_valid
    );
