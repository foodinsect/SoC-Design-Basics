...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_init_controller is
  ...
  signal wait_init_done : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of pmoden_o_i_7 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_4\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \state[3]_i_5\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of timer_clear_i_2 : label is "soft_lutpair6";
begin
  PMODEN <= \^pmoden\;
  RES <= \^res\;
  VCCEN <= \^vccen\;
...
dc_o_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F20"
    )
        port map (
...
timer_clear_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of CE_i_1 : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_2\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of done_i_1 : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \shift_reg[4]_i_1\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair11";
begin
