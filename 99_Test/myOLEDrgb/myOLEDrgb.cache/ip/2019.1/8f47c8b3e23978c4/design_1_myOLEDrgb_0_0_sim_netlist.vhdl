...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_oled_controller is
  port (
    ...
    \data_o_reg[7]_1\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_oled_controller is
  ...
  signal \cmd_index__0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  signal \cmd_index_rep[3]_i_3_n_0\ : STD_LOGIC;
  ...
  signal wait_timer0 : STD_LOGIC_VECTOR ( 19 downto 1 );
  signal \wait_timer_done__18\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cmd_index_rep[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \cmd_index_rep[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cmd_index_rep[3]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cmd_index_rep[3]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of res_o_i_3 : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \wait_timer[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \wait_timer[10]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \wait_timer[11]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \wait_timer[12]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \wait_timer[13]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \wait_timer[14]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \wait_timer[15]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \wait_timer[16]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \wait_timer[17]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \wait_timer[18]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \wait_timer[19]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \wait_timer[2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \wait_timer[3]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \wait_timer[4]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \wait_timer[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \wait_timer[6]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \wait_timer[7]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \wait_timer[8]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \wait_timer[9]_i_1\ : label is "soft_lutpair14";
begin
  DC <= \^dc\;
  SPI_start <= \^spi_start\;
  VCCEN <= \^vccen\;
...
\cmd_index_rep[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000080000F0000"
    )
        port map (
...
\cmd_index_rep[3]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"15FF"
    )
        port map (
...
init_done_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFEF0420"
    )
        port map (
...
\pixel_index[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00020000"
    )
        port map (
...
\state[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => state(0),
      I4 => state(3),
      I5 => \cmd_index_rep[3]_i_3_n_0\,
      O => \state[2]_i_1_n_0\
    );
\state[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0F0F000EAEAAAAA"
    )
        port map (
      I0 => \state[3]_i_3_n_0\,
...
\wait_timer_reg[12]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => wait_timer0(12 downto 9),
      S(3 downto 0) => wait_timer(12 downto 9)
    );
...
\wait_timer_reg[16]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => wait_timer0(16 downto 13),
      S(3 downto 0) => wait_timer(16 downto 13)
    );
...
\wait_timer_reg[19]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(2 downto 0) => wait_timer0(19 downto 17),
      S(3) => '0',
      S(2 downto 0) => wait_timer(19 downto 17)
    );
...
\wait_timer_reg[4]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => wait_timer(0),
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => wait_timer0(4 downto 1),
      S(3 downto 0) => wait_timer(4 downto 1)
    );
...
\wait_timer_reg[8]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => wait_timer0(8 downto 5),
      S(3 downto 0) => wait_timer(8 downto 5)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myOLEDrgb_v1_0 is
  ...
  signal spi_input_data : STD_LOGIC_VECTOR ( 7 downto 0 );
...
myOLEDrgb_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myOLEDrgb_v1_0_S00_AXI
     port map (
      Q(0) => pixel_valid,
      SPI_done => SPI_done,
      \axi_rdata_reg[0]_0\ => spi_master_inst_n_4,
      init_done => init_done,
      ...
      \slv_reg2_reg[7]_0\(7 downto 0) => pixel(7 downto 0)
    );
spi_master_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master
     port map (
      ...
      MOSI => MOSI,
      Q(7 downto 0) => spi_input_data(7 downto 0),
      SPI_done => SPI_done,
      SPI_start => SPI_start,
      s00_axi_aclk => s00_axi_aclk,
      sclk_reg_0 => sclk_reg
...
u_oled_controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_oled_controller
     port map (
      ...
      SPI_start => SPI_start,
      VCCEN => VCCEN,
      \data_o_reg[7]_0\(7 downto 0) => spi_input_data(7 downto 0),
      \data_o_reg[7]_1\(7 downto 0) => pixel(7 downto 0),
      init_done => init_done,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_aresetn => s00_axi_aresetn,
