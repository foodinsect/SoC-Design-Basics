...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_oled_controller is
  port (
    ...
    spi_start_o_reg_0 : in STD_LOGIC;
    vccen_o_reg_1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    s00_axi_aresetn : in STD_LOGIC;
    spi_start_o_reg_1 : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
...
\data_o[7]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFDFFF0FFFFFFF"
    )
        port map (
      I0 => spi_start_o_reg_1(0),
      I1 => \^spi_start\,
...
u_oled_controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_oled_controller
     port map (
      ...
      spi_start_o_reg_1(0) => pixel_valid,
