...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bar_graph_controller is
  port (
    rect_en : out STD_LOGIC;
    rect_data : out STD_LOGIC;
    rect_dc : out STD_LOGIC;
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bar_graph_controller;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bar_graph_controller is
  ...
  signal \cmd_index[3]_i_1__0_n_0\ : STD_LOGIC;
  signal cmd_index_0 : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal commands : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \commands[3][0]_i_1_n_0\ : STD_LOGIC;
  signal \commands[3][0]_i_2_n_0\ : STD_LOGIC;
  signal \commands[6][0]_i_1_n_0\ : STD_LOGIC;
  signal \commands_reg[3]\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \commands_reg[6]\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \data_o[0]_i_1__0_n_0\ : STD_LOGIC;
  signal \data_o[0]_i_3_n_0\ : STD_LOGIC;
  signal \dc_o_i_1__0_n_0\ : STD_LOGIC;
  signal \^rect_data\ : STD_LOGIC;
  signal \^rect_dc\ : STD_LOGIC;
  signal \^rect_en\ : STD_LOGIC;
  signal \spi_en_i_1__0_n_0\ : STD_LOGIC;
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "IDLE:000,SEND_CMD:010,NEXT_CMD:011,DONE:100,LOAD_CMD:001";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "IDLE:000,SEND_CMD:010,NEXT_CMD:011,DONE:100,LOAD_CMD:001";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "IDLE:000,SEND_CMD:010,NEXT_CMD:011,DONE:100,LOAD_CMD:001";
  attribute SOFT_HLUTNM of \cmd_index[0]_i_1__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cmd_index[1]_i_1__0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cmd_index[2]_i_1__0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cmd_index[3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_o[0]_i_3\ : label is "soft_lutpair2";
begin
  rect_data <= \^rect_data\;
  rect_dc <= \^rect_dc\;
  rect_en <= \^rect_en\;
...
\cmd_index[0]_i_1__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\cmd_index[1]_i_1__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"28"
    )
        port map (
...
\cmd_index[2]_i_1__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2A80"
    )
        port map (
...
\cmd_index[3]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
...
\commands[3][0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\commands[3][0]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\commands[6][0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFFFE00"
    )
        port map (
...
\commands_reg[3][0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\commands_reg[6][0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\data_o[0]_i_2__0\: unisim.vcomponents.LUT6
    generic map(
...
\dc_o_i_1__0\: unisim.vcomponents.LUT6
    generic map(
...
\spi_en_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFEE0004"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_init_controller is
  port (
    ...
    init_data : out STD_LOGIC;
    init_dc : out STD_LOGIC;
    RES : out STD_LOGIC;
    VCCEN : out STD_LOGIC;
    PMODEN : out STD_LOGIC;
    init_done : out STD_LOGIC;
    s00_axi_aclk : in STD_LOGIC;
    pmoden_o_reg_0 : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
    spi_done : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_init_controller is
  ...
  signal \data_o[0]_i_3__0_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \cmd_index[2]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \cmd_index[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \cmd_index[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_o[0]_i_3__0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of dc_o_i_3 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of init_done_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of pmoden_o_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of pmoden_o_i_4 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of pmoden_o_i_5 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of pmoden_o_i_7 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of res_o_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of res_o_i_4 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_4\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state[3]_i_10\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state[3]_i_11\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[3]_i_12\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[3]_i_13\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \state[3]_i_14\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \state[3]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \state[3]_i_9\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of timer_clear_i_4 : label is "soft_lutpair12";
...
\data_o[0]_i_3__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
\pixel_index_reg[17]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[18]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[19]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[20]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[21]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[22]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[23]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[24]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[25]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[26]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[27]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[28]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[29]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[30]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
\pixel_index_reg[31]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => pixel_index,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myOLEDrgb_v1_0_S00_AXI is
  port (
    ...
    s00_axi_aclk : in STD_LOGIC;
    init_dc : in STD_LOGIC;
    rect_dc : in STD_LOGIC;
    \shift_reg_reg[0]\ : in STD_LOGIC;
    rect_en : in STD_LOGIC;
    init_en : in STD_LOGIC;
    init_done : in STD_LOGIC;
    rect_data : in STD_LOGIC;
...
DC_INST_0: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00E2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM of \bit_cnt[0]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \bit_cnt[1]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \bit_cnt[2]_i_1\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of done_i_1 : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \shift_reg[7]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair18";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myOLEDrgb_v1_0 is
  ...
  signal myOLEDrgb_v1_0_S00_AXI_inst_n_11 : STD_LOGIC;
  signal myOLEDrgb_v1_0_S00_AXI_inst_n_9 : STD_LOGIC;
  signal rect_data : STD_LOGIC;
  signal rect_dc : STD_LOGIC;
  signal rect_en : STD_LOGIC;
  signal spi_done : STD_LOGIC;
...
begin
bar_graph_ctrl: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bar_graph_controller
     port map (
...
init_ctrl: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_init_controller
     port map (
      PMODEN => PMODEN,
      Q(0) => init_start,
      RES => RES,
...
myOLEDrgb_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myOLEDrgb_v1_0_S00_AXI
     port map (
      D(0) => myOLEDrgb_v1_0_S00_AXI_inst_n_11,
      DC => DC,
      \FSM_onehot_state_reg[0]\ => myOLEDrgb_v1_0_S00_AXI_inst_n_9,
      Q(1 downto 0) => mode(1 downto 0),
...
spi: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master
     port map (
      ...
      Q(1 downto 0) => mode(1 downto 0),
      SCK => SCK,
      \bit_cnt_reg[0]_0\ => myOLEDrgb_v1_0_S00_AXI_inst_n_9,
      init_en => init_en,
      rect_en => rect_en,
      s00_axi_aclk => s00_axi_aclk,
      spi_done => spi_done
