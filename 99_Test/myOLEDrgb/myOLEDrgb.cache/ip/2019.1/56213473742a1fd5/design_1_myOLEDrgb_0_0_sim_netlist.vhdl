...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  signal \rect_cmds[12][4]_i_1_n_0\ : STD_LOGIC;
  signal \rect_cmds[8][7]_i_1_n_0\ : STD_LOGIC;
  signal \rect_cmds__51\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \rect_cmds_reg[11]\ : STD_LOGIC_VECTOR ( 5 downto 4 );
  signal \rect_cmds_reg[12]\ : STD_LOGIC_VECTOR ( 5 downto 4 );
  signal \rect_cmds_reg[8]\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \cmd_index[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \cmd_index[3]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \cmd_index[5]_i_4\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \data_o[1]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \data_o[3]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \data_o[4]_i_2\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of dc_o_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of dc_o_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of dc_o_i_4 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of dc_o_i_5 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of dc_o_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of dc_o_i_7 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of dc_o_i_8 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of dc_o_i_9 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \rect_cmds[11][4]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \rect_cmds[11][5]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \rect_cmds[12][4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rect_cmds[12][5]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of res_o_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of res_o_i_3 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of res_o_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of res_o_i_5 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of res_o_i_6 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of spi_en_i_4 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of spi_en_i_5 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of spi_en_i_6 : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_14\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[3]_i_16\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state[3]_i_17\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \state[3]_i_18\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[3]_i_19\ : label is "soft_lutpair5";
...
\data_o[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0FC00C3B03000C3B"
    )
        port map (
      I0 => \rect_cmds_reg[8]\(0),
      I1 => cmd_index(3),
      I2 => cmd_index(2),
      I3 => cmd_index(0),
      I4 => cmd_index(1),
      I5 => \rect_cmds_reg[11]\(4),
      O => \rect_cmds__51\(0)
    );
...
\data_o[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAEEFEAAFFAAAA"
    )
        port map (
      I0 => \data_o[3]_i_4_n_0\,
      I1 => \data_o[1]_i_3_n_0\,
      I2 => \rect_cmds_reg[8]\(1),
      I3 => cmd_index(1),
      I4 => cmd_index(2),
      I5 => cmd_index(3),
      O => \rect_cmds__51\(1)
...
\data_o[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00CF00F000000FAF"
    )
        port map (
      I0 => \rect_cmds_reg[8]\(2),
      I1 => \rect_cmds_reg[11]\(4),
      I2 => cmd_index(3),
      I3 => cmd_index(2),
      I4 => cmd_index(1),
      I5 => cmd_index(0),
...
\data_o[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"D490000000000000"
    )
        port map (
      I0 => cmd_index(0),
      I1 => cmd_index(1),
      I2 => \rect_cmds_reg[12]\(4),
      I3 => \rect_cmds_reg[11]\(4),
      I4 => cmd_index(2),
      I5 => cmd_index(3),
      O => \data_o[2]_i_3_n_0\
    );
...
\data_o[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFCE0E0000"
    )
        port map (
      I0 => \rect_cmds_reg[8]\(3),
      I1 => cmd_index(0),
      I2 => cmd_index(1),
      I3 => \rect_cmds_reg[11]\(4),
...
\data_o[3]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\data_o[3]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"C0AC00000000F000"
    )
        port map (
      I0 => \rect_cmds_reg[11]\(4),
      I1 => \rect_cmds_reg[12]\(4),
      I2 => cmd_index(1),
      I3 => cmd_index(0),
      I4 => cmd_index(3),
      I5 => cmd_index(2),
...
\data_o[4]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FC300000C0C0EE22"
    )
        port map (
      I0 => \rect_cmds_reg[8]\(4),
      I1 => cmd_index(2),
      I2 => \rect_cmds_reg[11]\(4),
      I3 => \rect_cmds_reg[12]\(4),
      I4 => cmd_index(1),
      I5 => cmd_index(0),
      O => \data_o[4]_i_3_n_0\
    );
...
\data_o[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => cmd_index(3),
      I2 => cmd_index(0),
      I3 => \rect_cmds_reg[11]\(5),
      I4 => \rect_cmds_reg[8]\(5),
      I5 => cmd_index(1),
      O => \data_o[5]_i_2_n_0\
    );
...
\data_o[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F555DDDD5555DDDD"
    )
        port map (
      I0 => \state_reg_n_0_[0]\,
      I1 => g0_b7_n_0,
      I2 => \data_o[7]_i_3_n_0\,
      I3 => \rect_cmds_reg[8]\(7),
      I4 => \state_reg_n_0_[3]\,
...
\rect_cmds[11][4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\rect_cmds[11][5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\rect_cmds[12][4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0103"
    )
        port map (
      ...
      I2 => y(7),
      I3 => y(5),
      O => \rect_cmds[12][4]_i_1_n_0\
    );
\rect_cmds[12][5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00005557"
    )
        port map (
...
\rect_cmds[8][7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02000000"
    )
        port map (
      ...
      I3 => \state_reg_n_0_[1]\,
      I4 => \state_reg_n_0_[3]\,
      O => \rect_cmds[8][7]_i_1_n_0\
    );
\rect_cmds_reg[11][4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => s00_axi_aclk,
      CE => \rect_cmds[8][7]_i_1_n_0\,
      D => channel_B(4),
      Q => \rect_cmds_reg[11]\(4),
      R => '0'
    );
\rect_cmds_reg[11][5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => \rect_cmds[8][7]_i_1_n_0\,
      D => channel_B(5),
      Q => \rect_cmds_reg[11]\(5),
      R => '0'
    );
\rect_cmds_reg[12][4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => s00_axi_aclk,
      CE => \rect_cmds[8][7]_i_1_n_0\,
      D => \rect_cmds[12][4]_i_1_n_0\,
      Q => \rect_cmds_reg[12]\(4),
      R => '0'
    );
\rect_cmds_reg[12][5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => \rect_cmds[8][7]_i_1_n_0\,
      D => channel_A(5),
      Q => \rect_cmds_reg[12]\(5),
      R => '0'
    );
\rect_cmds_reg[8][0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\rect_cmds_reg[8][1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\rect_cmds_reg[8][2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\rect_cmds_reg[8][3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\rect_cmds_reg[8][4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\rect_cmds_reg[8][5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\rect_cmds_reg[8][6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\rect_cmds_reg[8][7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
