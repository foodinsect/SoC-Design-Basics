...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  attribute SOFT_HLUTNM of \cmd_index[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \cmd_index[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \cmd_index[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \cmd_index[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \cmd_index[5]_i_4\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \data_o[3]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_o[4]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \data_o[5]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \data_o[7]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \data_o[7]_i_4\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \data_o[7]_i_5\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of dc_o_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of dc_o_i_3 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of dc_o_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of dc_o_i_7 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of dc_o_i_8 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \pixel_index[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \pixel_index[31]_i_10\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \rect_cmds[6][4]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \rect_cmds[6][5]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of res_o_i_4 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of spi_en_i_2 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_10\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \state[3]_i_13\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of timer_clear_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of timer_clear_i_4 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of timer_clear_i_5 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of timer_clear_i_7 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of timer_clear_i_8 : label is "soft_lutpair0";
begin
  DC <= \^dc\;
  PMODEN <= \^pmoden\;
  RES <= \^res\;
...
\data_o[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"77F777F7FFFF55F5"
    )
        port map (
      I0 => \state_reg_n_0_[0]\,
      I1 => \data_o[3]_i_2_n_0\,
      I2 => \data_o[5]_i_3_n_0\,
      I3 => \data_o[2]_i_2_n_0\,
      I4 => g0_b2_n_0,
      I5 => \state_reg_n_0_[3]\,
      O => \data_o[2]_i_1_n_0\
    );
...
\data_o[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"30FF0000BABA0000"
    )
        port map (
      I0 => g0_b4_n_0,
      I1 => \data_o[4]_i_2_n_0\,
      I2 => \data_o[5]_i_3_n_0\,
      I3 => \data_o[4]_i_3_n_0\,
      I4 => \state_reg_n_0_[1]\,
      I5 => \state_reg_n_0_[3]\,
      O => \data_o[4]_i_1_n_0\
    );
\data_o[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"554F507F557F5F7F"
    )
        port map (
      I0 => \rect_cmds_reg[3]\(4),
      I1 => cmd_index(2),
      I2 => cmd_index(3),
      I3 => cmd_index(1),
      I4 => cmd_index(0),
...
\data_o[4]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"577477FF"
    )
        port map (
...
dc_o_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\pixel_index[31]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
timer_clear_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFBFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM of MOSI_i_1 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \bit_cnt[0]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \bit_cnt[1]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \bit_cnt[2]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_3\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \counter[0]_i_1\ : label is "soft_lutpair26";
  ...
  attribute SOFT_HLUTNM of \shift_reg[0]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \shift_reg[1]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair23";
begin
  MOSI <= \^mosi\;
  spi_done <= \^spi_done\;
