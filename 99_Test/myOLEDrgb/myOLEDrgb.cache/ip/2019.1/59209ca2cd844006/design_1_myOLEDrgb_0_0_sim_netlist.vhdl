...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_controller is
  ...
  attribute SOFT_HLUTNM of \cmd_index[4]_i_2\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \data_o[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_o[1]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \data_o[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_o[2]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \data_o[2]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_o[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_o[4]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_o[4]_i_5\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_o[7]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of dc_o_i_2 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of dc_o_i_4 : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \pixel_index[10]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \pixel_index[11]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \pixel_index[12]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \pixel_index[13]_i_1\ : label is "soft_lutpair29";
  ...
  attribute SOFT_HLUTNM of \pixel_index[18]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \pixel_index[19]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \pixel_index[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \pixel_index[20]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \pixel_index[21]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \pixel_index[22]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \pixel_index[23]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \pixel_index[24]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \pixel_index[25]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \pixel_index[26]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \pixel_index[27]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \pixel_index[28]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \pixel_index[29]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \pixel_index[2]_i_1\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \pixel_index[3]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \pixel_index[4]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \pixel_index[5]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \pixel_index[6]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \pixel_index[7]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \pixel_index[8]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \pixel_index[9]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of pmoden_o_i_6 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rect_cmds[6][5]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rect_cmds[7][4]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \state[4]_i_11\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[4]_i_12\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state[4]_i_14\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state[4]_i_9\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of timer_clear_i_3 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of timer_clear_i_4 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of timer_clear_i_6 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of timer_clear_i_8 : label is "soft_lutpair3";
begin
  DC <= \^dc\;
  PMODEN <= \^pmoden\;
  RES <= \^res\;
...
\data_o[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\data_o[4]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EA9D"
    )
        port map (
...
dc_o_i_10: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
pmoden_o_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
\state[4]_i_19\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000400"
    )
        port map (
...
timer_clear_i_10: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7FFF"
    )
        port map (
...
timer_clear_i_9: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_spi_master is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of CE_i_1 : label is "soft_lutpair37";
  ...
  attribute SOFT_HLUTNM of MOSI_i_1 : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \bit_cnt[0]_i_1\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \bit_cnt[1]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \bit_cnt[2]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_2\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \bit_cnt[3]_i_3\ : label is "soft_lutpair38";
  ...
  attribute SOFT_HLUTNM of \counter[2]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \shift_reg[0]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \shift_reg[1]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of spi_clk_i_1 : label is "soft_lutpair36";
begin
  MOSI <= \^mosi\;
  spi_done <= \^spi_done\;
