...
proc create_root_design { parentCell } {
  ...
  set RGBLED [ create_bd_port -dir O -from 2 -to 0 RGBLED ]
  ...
  # Create instance: myTimer_1, and set properties
  set myTimer_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:myTimer:1.0 myTimer_1 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins myTimer_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net myTimer_0_oIRQ [get_bd_pins myTimer_0/oIRQ] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net myTimer_0_oRGB [get_bd_ports RGBLED] [get_bd_pins myTimer_0/oRGB]
  connect_bd_net -net myTimer_1_oIRQ [get_bd_pins myTimer_1/oIRQ] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net myTimer_1_oRGB [get_bd_ports RGB] [get_bd_pins myTimer_1/oRGB]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins myTimer_0/s00_axi_aclk] [get_bd_pins myTimer_1/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins myTimer_0/s00_axi_aresetn] [get_bd_pins myTimer_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myTimer_1/S00_AXI/S00_AXI_reg] SEG_myTimer_1_S00_AXI_reg
