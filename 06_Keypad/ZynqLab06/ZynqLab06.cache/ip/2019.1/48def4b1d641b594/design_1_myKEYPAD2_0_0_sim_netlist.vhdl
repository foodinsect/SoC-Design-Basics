...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Keypad is
  ...
  signal oKEYNUMz : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_current_state[4]_i_7\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \delay_counter[10]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \delay_counter[11]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \delay_counter[12]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \delay_counter[13]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \delay_counter[14]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \delay_counter[15]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \delay_counter[16]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \delay_counter[17]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \delay_counter[18]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \delay_counter[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \delay_counter[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \delay_counter[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \delay_counter[4]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \oCOL[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \oCOL[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \oCOL[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \oCOL[3]_i_2\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \oKEYST[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \oKEYST[10]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \oKEYST[11]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \oKEYST[12]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \oKEYST[13]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \oKEYST[14]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \oKEYST[15]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \oKEYST[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \oKEYST[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \oKEYST[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \oKEYST[4]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \oKEYST[5]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \oKEYST[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \oKEYST[7]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \oKEYST[8]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \oKEYST[9]_i_1\ : label is "soft_lutpair10";
begin
...
oIRQ_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BE"
    )
        port map (
...
\oKEYNUM[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0EE0E000E0000000"
        ...
        port map (
      I0 => \oKEYNUM[3]_i_3_n_0\,
      I1 => \oKEYNUM[3]_i_4_n_0\,
      I2 => iROW(3),
      I3 => iROW(4),
      I4 => iROW(2),
      I5 => iROW(1),
...
\oKEYNUMz_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \^q\(0),
...
\oKEYNUMz_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \^q\(1),
...
\oKEYNUMz_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \^q\(2),
...
\oKEYNUMz_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => \^q\(3),
...
KEYPAD: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Keypad
     port map (
      ...
      oIRQ => oIRQ,
      \oKEYST_reg[15]_0\(15) => KEYPAD_n_5,
      \oKEYST_reg[15]_0\(14) => KEYPAD_n_6,
      \oKEYST_reg[15]_0\(13) => KEYPAD_n_7,
      \oKEYST_reg[15]_0\(12) => KEYPAD_n_8,
      \oKEYST_reg[15]_0\(11) => KEYPAD_n_9,
      \oKEYST_reg[15]_0\(10) => KEYPAD_n_10,
      \oKEYST_reg[15]_0\(9) => KEYPAD_n_11,
      \oKEYST_reg[15]_0\(8) => KEYPAD_n_12,
      \oKEYST_reg[15]_0\(7) => KEYPAD_n_13,
      \oKEYST_reg[15]_0\(6) => KEYPAD_n_14,
      \oKEYST_reg[15]_0\(5) => KEYPAD_n_15,
      \oKEYST_reg[15]_0\(4) => KEYPAD_n_16,
      \oKEYST_reg[15]_0\(3) => KEYPAD_n_17,
      \oKEYST_reg[15]_0\(2) => KEYPAD_n_18,
      \oKEYST_reg[15]_0\(1) => KEYPAD_n_19,
      \oKEYST_reg[15]_0\(0) => KEYPAD_n_20,
...
myKEYPAD2_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myKEYPAD2_v1_0_S00_AXI
     port map (
      Q(3 downto 0) => oKEYNUM(3 downto 0),
      SR(0) => myKEYPAD2_v1_0_S00_AXI_inst_n_1,
      \axi_rdata_reg[15]_0\(15) => KEYPAD_n_5,
      \axi_rdata_reg[15]_0\(14) => KEYPAD_n_6,
      \axi_rdata_reg[15]_0\(13) => KEYPAD_n_7,
      \axi_rdata_reg[15]_0\(12) => KEYPAD_n_8,
      \axi_rdata_reg[15]_0\(11) => KEYPAD_n_9,
      \axi_rdata_reg[15]_0\(10) => KEYPAD_n_10,
      \axi_rdata_reg[15]_0\(9) => KEYPAD_n_11,
      \axi_rdata_reg[15]_0\(8) => KEYPAD_n_12,
      \axi_rdata_reg[15]_0\(7) => KEYPAD_n_13,
      \axi_rdata_reg[15]_0\(6) => KEYPAD_n_14,
      \axi_rdata_reg[15]_0\(5) => KEYPAD_n_15,
      \axi_rdata_reg[15]_0\(4) => KEYPAD_n_16,
      \axi_rdata_reg[15]_0\(3) => KEYPAD_n_17,
      \axi_rdata_reg[15]_0\(2) => KEYPAD_n_18,
      \axi_rdata_reg[15]_0\(1) => KEYPAD_n_19,
      \axi_rdata_reg[15]_0\(0) => KEYPAD_n_20,
      s00_axi_aclk => s00_axi_aclk,
