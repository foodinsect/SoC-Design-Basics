...
HD_PWD='e:/01_soc/06_keypad/zynqlab06/zynqlab06.tmp/mykeypad2_v1_0_project/myKEYPAD2_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myKEYPAD2_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myKEYPAD2_v1_0.tcl -notrace
