...
HD_PWD='E:/SoC/04_ZynqLab01/ZynqLab03/ZynqLab03.runs/design_1_myTimer_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myTimer_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myTimer_0_2.tcl
