...
HD_PWD='F:/01_SoC/myOLEDrgb_SW/myOLEDrgb_SW.runs/design_1_OLEDrgb_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_OLEDrgb_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_OLEDrgb_0_1.tcl
